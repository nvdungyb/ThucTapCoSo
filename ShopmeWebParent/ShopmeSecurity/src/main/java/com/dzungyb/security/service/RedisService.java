...
public class RedisService {
    ...
    public String getLastSentTime(String email) {
        ...
        if (lastTime == null) {
            log.warn("No timestamp found for email: {}", MailService.maskEmail(email));
        }
        return lastTime;
    }
    ...
    public String getAuthCode(String email) {
        ...
        if (authCode == null) {
            log.warn("No auth code found for email: {}", MailService.maskEmail(email));
        }
        return authCode;
    }
    ...
    public String getChangePasswordToken(@Email String email) {
        ...
        if (token == null) {
            log.warn("No change password token found for email: {}", MailService.maskEmail(email));
        }
        return token;
    }
